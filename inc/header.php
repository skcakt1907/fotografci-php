    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item nav-dropdown">
          <a class="nav-link <?= in_array($current,['hizmetler.php','hizmet-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/hizmetler">Çekim Türleri <i class="bi bi-chevron-down ms-1" style="font-size:.7rem"></i></a>
        ...
        <li class="nav-item"><a class="nav-link <?= in_array($current,['projeler.php','proje-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/projeler">Portfolyo</a></li>
        ...
        <li class="nav-item"><a class="nav-link nav-cta" href="<?= SITE_URL ?>/teklif">Rezervasyon <i class="bi bi-arrow-right ms-1"></i></a></li>
      </ul>
    </div>
  </div>
</nav>
