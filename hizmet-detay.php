...
<section class="page-head">
  <div class="container">
    <h1><?= e($h['baslik']) ?></h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/hizmetler">Çekim Türleri</a></li><li class="breadcrumb-item active"><?= e($h['baslik']) ?></li></ol></nav>
  </div>
</section>
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-4">
        ...
        <div class="cta p-4 rounded text-center">
          <h5 style="color:#fff">Rezervasyon Yapmak İster misiniz?</h5>
