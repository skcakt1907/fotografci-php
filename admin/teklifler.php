...
if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['id'])){
    ...
    adminFlash('Rezervasyon güncellendi.');
...
<div class="card mb-4">
  <div class="card-header d-flex justify-content-between">
    <div><i class="bi bi-clipboard-check me-2" style="color:var(--primary)"></i><strong>Rezervasyon #<?= $detay['id'] ?></strong> — <?= e($detay['ad']) ?></div>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div><i class="bi bi-clipboard-check me-2"></i>Tüm Rezervasyonlar (<?= count($liste) ?>)</div>
